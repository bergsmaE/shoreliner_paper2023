...
\Author{Erwin W.J. Bergsma $^{1}$*\orcidA{}, Adrien Klotz $^{1,2}$, St\'{e}phanie Artigues$^{1}$, Marcan Graffin$^{1,2}$, Anna Prenowitz $^{1}$, Jean-Marc Delvit$^{1}$ and Rafael Almar$^{2}$}

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Erwin W.J. Bergsma, Adrien Klotz, St\'{e}phanie Artigues, Marcan Graffin, Anna Prenowitz, Jean-Marc Delvit and Rafael Almar}

% MDPI internal command: Authors, for citation in the left column
\AuthorCitation{Bergsma, E.W.J.; Klotz, A.; Artigues, S.; Graffin, M, Prenowitz, A., Devit, J-M., Almar, R}
...
\begin{table}[H] 
\caption{Comparitive performance SCoWI and Coastsat obtained around the FRF at Duck, US.\label{tab1}}
\newcolumntype{C}{>{\centering\arraybackslash}X}
\begin{tabularx}{\textwidth}{CCCCCC}
\toprule
\textbf{Method}	& \textbf{Case} & \textbf{Comp. time} & \textbf{RMSD} & \textbf{Bias}  & \textbf{Std} \\
\midrule
Coastsat            & best & 27.873 sec	   & 16.7 m & 16.3 m &  3.5 m\\
ScoWI (shoreliner)  & best & 2.237 sec	   & 2.6 m  &  0.8 m &  2.5 m\\
Coastsat            & all-data & -         & 19.1 m & 15.1 m & 11.8 m\\
ScoWI (shoreliner)  & all-data & -         & 8.3 m  & -3.6 m &  7.5 m\\
\bottomrule
\end{tabularx}
\end{table}
