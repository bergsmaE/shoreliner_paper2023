...
\Title{Sub-pixel shoreline extraction method using multispectral satellite imagery}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Sub-pixel shoreline extraction method using multi-spectral satellite imagery}
...
\Author{Adrien Klotz $^{1}$\orcidA{}, Erwin W.J. Bergsma $^{2,\ddagger}$*\orcidB{}, St\'{e}phanie Artigues$^{2}$, Marcan Graffin$^{2}$ and Anna Prenowitz $^{2,}$}
